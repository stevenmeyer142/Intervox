...
public class Configuration extends DataModel
    implements Serializable, java.lang.Cloneable, DataModelListener {
  ...
  private transient CalculatedOffset fSelectedOffset = null;
  ...
  public static final String kOffsetNameProperty = "Offset: ";
  public static final String kDeviceNameProperty = "Device: ";
  public static final String kPortNameProperty = "Port: ";
  public static final String kBlankString = "NONE";
  private static final String kNoFileName = "NO FILE";

  private static final String[] kProperties = {
      kOffsetNameProperty, kDeviceNameProperty, kPortNameProperty
  };
  ...
  public void SelectOffset(CalculatedOffset offset) {
    ...
    if (Debug.fgDebugging && offset != null && !fOffsets.contains(offset)) {
      NeuroSynchUtil.ErrorMessage(
          "Configuration.SelectOffset, offset not in list", NeuroSynchUtil.kNoDlog);
    }
  }
  ...
  public void ProcessLocalizerPoint(LocalizerPointOutput output) {
    if (fUsingOffset && IsOffsetStation(output.GetStation())) {
      ...
      if (offset != null && rotation != null && realPoint != null) {
        ...
        NeuroSynchUtil.ErrorMessage(
            "Configuration.ProcessLocalizerPoint, offset- " + offset + " angle- " + rotation,
   ...
   * {
   * return fDirty || fLocalizer.IsDirty() || (fLayoutSelections != null &&
   * fLayoutSelections.IsDirty());
   * }
   */
