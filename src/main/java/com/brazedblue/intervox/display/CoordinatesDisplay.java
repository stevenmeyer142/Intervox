...
/**
 * View Object to display a Point with labels for each coordinate.
 * Dimensions of coordinate system determing by labels.length in SetLabels
 *
 * @version 1 6/4/98
 * @author Steve Meyer
 */
 ...
 * Dimensions of coordinate system determing by labels.length in SetLabels
 *
 * @param labels, array which determines the labels, i.e. "x,y,etc..." and the number of coordinates
 */
