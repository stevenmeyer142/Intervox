  ...
  public void Paint(Graphics g, AdornedComponent c) {
    if (fImage != null) {
      ...
      if (imgSize.width < imageDrawArea.width) {
        ...
        g.fillRect(
            imgSize.width + left, top, imageDrawArea.width - imgSize.width, imageDrawArea.height);
        g.setColor(Color.white);
      } else if (imgSize.height < imageDrawArea.height) {
        g.setColor(Color.black);
        g.fillRect(
            left, imgSize.height + top, imageDrawArea.width, imageDrawArea.height - imgSize.height);
        g.setColor(Color.white);
      }
    }
  }
