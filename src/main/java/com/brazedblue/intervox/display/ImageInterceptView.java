...
public class ImageInterceptView extends ImageSeriesView /* implements anInterface */ {
  ...
  public void DisplayTrackerOutput(DeviceOutput output, TransformerAccess transformer) {
     ...
     * if (transformer.CanTransform(output.GetSpaceID(), GetSpaceID()) && rotation
     * != null
     * && realPoint != null)
     * {
     * FloatPoint virtualPoint = new FloatPoint((FloatPoint)realPoint);
     * virtualPoint = transformer.TransformPoint(virtualPoint, output.GetSpaceID(),
     * GetSpaceID());
     ...
     * {
     * CalculatedOffset offsetCalculations =
     * trackerSettings.GetTrackerCalculatedOffset();
     * 
     ...
     * xIncVector = transformer.TransformVector(xIncVector, output.GetSpaceID(),
     * GetSpaceID());
     ...
     * {
     * distance = (fPerspective.CurrentDepth() - trackerPos.Get(myAxis)) /
     * xIncVector.Get(myAxis);
     * }
     * 
     ...
     * inverseTransformedPoint = transformer.TransformPoint(inverseTransformedPoint,
     * GetSpaceID(), output.GetSpaceID());
     * 
