...
public class ImageViewType implements java.io.Serializable, java.lang.Cloneable {
  ...
  public void SetAutoScrolls(boolean autoScrolls) {
    if (!autoScrolls
        && (fAxis == OrthoImageSetController.kAxial
            || fAxis == OrthoImageSetController.kSagittal
            || fAxis == OrthoImageSetController.kCoronal)) {
  ...
  public static ImageViewType NewImageViewType(
      String axisString,
      boolean scrolls,
      boolean tracks,
      String magnificationString,
      ImageViewType oldViewType) {
