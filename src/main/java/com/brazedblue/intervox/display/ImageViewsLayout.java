...
public class ImageViewsLayout implements java.io.Serializable, LayoutModel, java.lang.Cloneable {
  ...
  void SetLayoutType(int layoutType) {
    ...
    switch (layoutType) {
      case kDefaultLayout: {
        fSpecs = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kCoronal, 1, true, kHasPopup, kShowsFiducial, true));
        ImageViewSpec nextSpec = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kSagittal, 1, true, kHasPopup, kShowsFiducial, true));
        fSpecs.SetNextRightSpec(nextSpec);
        nextSpec.SetNextRightSpec(
            new ImageViewSpec(
                new ImageViewType(
                    OrthoImageSetController.kAxial, 1, true, kHasPopup, kShowsFiducial, true)));
      }
        break;
      ...
      case kSmallPrimaryCoronal: {
        ...
        fSpecs = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kCoronal,
                factor * 1,
                true,
                kHasPopup,
                kShowsFiducial,
        ...
        ImageViewSpec nextSpec = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kSagittal,
                factor * .5f,
                true,
                kHasPopup,
                kShowsFiducial,
                true));
        fSpecs.SetNextRightSpec(nextSpec);
        nextSpec.SetNextBottomSpec(
            new ImageViewSpec(
                new ImageViewType(
                    OrthoImageSetController.kAxial,
                    factor * .5f,
                    true,
                    kHasPopup,
                    kShowsFiducial,
      ...
      case k3ViewTrajectory: {
        fSpecs = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kTrajectory,
                2,
                false,
                !kHasPopup,
                !kShowsFiducial,
                true));
        ImageViewSpec spec2 = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kAxial, 1, true, kHasPopup, kShowsFiducial, true));
        fSpecs.SetNextRightSpec(spec2);
        ImageViewSpec spec3 = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kCoronal, 1, true, kHasPopup, kShowsFiducial, true));
      ...
      case k3ViewInterceptAxial: {
        ...
        fSpecs = new ImageViewSpec(
            new ImageViewType(
                ...
                kShowsFiducial,
                true,
                ImageViewType.kTracksInterceptFeature));
        ImageViewSpec spec = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kTrajectory, 2, false, false, false, true));
      ...
      case kDoubleDefaultLayout: {
        fSpecs = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kCoronal, 1, true, kHasPopup, kShowsFiducial, true));
        ImageViewSpec bottomSpec = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kCoronal, 1, true, kHasPopup, kShowsFiducial, true));
        fSpecs.SetNextBottomSpec(bottomSpec);
        ImageViewSpec rightSpec = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kSagittal, 1, true, kHasPopup, kShowsFiducial, true));
        fSpecs.SetNextRightSpec(rightSpec);
        bottomSpec = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kSagittal, 1, true, kHasPopup, kShowsFiducial, true));
        rightSpec.SetNextBottomSpec(bottomSpec);
        ImageViewSpec rightSpec2 = new ImageViewSpec(
            new ImageViewType(
                OrthoImageSetController.kAxial, 1, true, kHasPopup, kShowsFiducial, true));
  ...
  public void CreateViews(Container container, Vector viewList) { // logging
    if (fSpecs != null) {
  ...
  private static int NextOrthogonalAxis(int axis) {
    axis++;
  ...
  public void LetUserChangeSettings(ImageViewType viewType) {
    ...
    if (viewSpec != null) {
       ...
       * 
       * JCheckBox autoScrolls = new JCheckBox("Autoscroll",
       * viewType.GetAutoScrolls());
       ...
       * 
       * ImageViewType newViewType = ImageViewType.NewImageViewType(axisString,
       * scrolls,
       ...
       * {
       * ImageViewSpec nextBottom = new ImageViewSpec(!addRightView.isSelected() ?
       * newViewType :
      ...
      NeuroSynchUtil.ErrorMessage(
          "ImageViewsLayout.LetUserChangeSettings- Couldn't find ImageViewSpec for type",
  ...
  class ImageViewsLayoutSettingsDialog extends ValidatingDialog implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if (GetCloseObject() == fOKButton) {
            if (fDeleteView.isSelected()) {
              ...
              ImageViewType newViewType = ImageViewType.NewImageViewType(
                  axisString, scrolls, tracks, magnificationString, fViewType);
              ...
              if (!fAddRightView.isSelected() && !fAddBottomView.isSelected()) {
                ...
                if (fAddBottomView.isSelected()) {
                  ImageViewSpec nextBottom = new ImageViewSpec(
                      !fAddRightView.isSelected()
                          ? newViewType
                          : (ImageViewType) newViewType.clone());
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == fPerspective) {
        ...
        if (ImageViewType.kProbeTrajectoryPerspective.equals(selection)
            || ImageViewType.k3DPerspective.equals(selection)) {
