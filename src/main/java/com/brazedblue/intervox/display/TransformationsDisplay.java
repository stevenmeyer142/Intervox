...
public class TransformationsDisplay extends ControlsDisplay
    implements ActionListener, TrackerListener {
  ...
  private static final String k3PointsSelectString = "All 3 Point";
  private static final String k4PointsSelectString = "All 4 Point";
  private static final String kSelectPointsString = "Select Points";

  private static final String kEnableString = "Enable Transform";

  public static final String kAccuracyStartString = " (";
  public static final String kAccuracyEndString = ")";

  private static final SpaceLink kDefaultSpaceLink = new SpaceLink() {
    public SingleSpaceID GetSpace1() {
      return SingleSpaceID.GetDefaultVirtualSpaceID();
    }

    public SingleSpaceID GetSpace2() {
      return SingleSpaceID.GetRealSpaceID();
    }
  };
  ...
  private void UpdateMobileCheckButton() {
    if (NeuroSynchUtil.GetImageGuided()) {
      ...
      if ((spaceLink == null)
          || spaceLink.GetSpace1().IsType(SingleSpaceID.kLocalizerType)
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getActionCommand().equals(TrackerController.kMobileCmd)
        && NeuroSynchUtil.GetImageGuided()) {
      ...
      if (model != null) {
        ...
        NeuroSynchUtil.ErrorMessage(
            "TransformationsDisplay.actionPerformed GetTransformationType returns null");
      }
    }
  }
  ...
  public void UpdateControls() {
    ...
    SetCurrentTransformChildPanel(
        transformType != null
            ? transformType.GetSelectedPointsDerivation()
  ...
  class TransformationsDisplaySpaceLinkListener
      implements SpaceLinkSelector.SpaceLinkSelectorListener {
