...
public class Transforms3PointDisplay extends TransformsSelectDisplay implements ActionListener {
  ...
  public Transforms3PointDisplay(TrackerController trackerController) {
    super(TransformationTypeModel.k3PointsDerived);
  ...
  public void UpdateControls() {
    ...
    if (registrations.length >= 3) {
      fTransformations = TransformationMatrix.GenerateAllRegistrationSetsOf3(
          registrations, transformer.IsUsingReference());
