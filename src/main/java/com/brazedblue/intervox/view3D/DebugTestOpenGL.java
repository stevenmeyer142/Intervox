...
public class DebugTestOpenGL extends JDialog {
    String[] rowNames = { "Light Position", "Light Specular", "Light ambient", "Light Diffuse", 
                            "Material Specular", "Material ambient", "Material diffuse", "Material shininess"};
   ...
   //         public String getColumnName(int column) {return rowNames[column];}
            public Class getColumnClass(int c) {return values[0][c].getClass();}
	    public boolean isCellEditable(int row, int col) {return col != 0;}
            public void setValueAt(Object aValue, int row, int column) { values[row][column] = (Float)aValue; }
         };
