...
VkResult VulkanExampleBase::createInstance()
{
	...
	{
		std::cout << "Debug utils extension present, setting up debug labels" << std::endl;
		vks::debugutils::setup(instance);
	}
	else
	{
		std::cout << "Debug utils extension not present" << std::endl;
	}
...
#endif
		benchmark.run([=, this]
					  { render(); }, vulkanDevice->properties);
...
bool VulkanExampleBase::initVulkan()
{
	...
	std::cout << "pyhsical device selected: " << selectedDevice << "\n";
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
	...
	if (vulkanExample->benchmark.active)
	{
		...
		dispatch_group_notify(concurrentGroup, notifyQueue, ^{
		  [NSApp terminate:nil];
		});
	}
}
...
{
	swapChain.create(&width, &height, settings.fullscreen);
}
#endif
