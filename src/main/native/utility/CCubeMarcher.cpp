...
CCubeMarcher::CCubeMarcher(bool *boolArray, short resolution, const C3DPoint &startPoint, short width, short height, short depth) : fBoolArray(boolArray), fWidth(width),
